...
################################################################################
## Form generated from reading UI file 'untitledfgxEqq.ui'
##
...
class Ui_application_pages(object):
    ...
    def retranslateUi(self, application_pages):
        ...
        self.label_3.setText(QCoreApplication.translate("application_pages", u"Página 1: Divices", None))
        self.label_2.setText(QCoreApplication.translate("application_pages", u"Página_2: ASCADA", None))
        self.label.setText(QCoreApplication.translate("application_pages", u"Página_3: Charts", None))
    # retranslateUi
